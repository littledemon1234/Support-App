      ...
      <div className="bg-[#353448] pt-8 mt-10 md:h-[600px] ">
        <div className=" flex md:flex-row flex-col md:justify-center md:gap-28  md:mr-0 mr-2 ml-[21px] md:ml-0 ">
          <div className="md:pl-20 md:w-[500px]">
            ...
            <Link className="bg-[#FFC059] mt-10  text-white rounded-md p-3" href={"/More details"} > More details</Link>
          </div>
          <Image className="w-full h-[320px] md:w-[500px] md:h-[422px] md:mt-0 mt-6" src={Agency} alt="Mask" width={500} height={500} />
        </div>
      </div>
    </div>
  );
