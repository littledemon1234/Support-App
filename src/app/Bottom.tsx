      ...
      <div className="md:pt-32 mt-7 md:mt-o flex xl:flex-row  flex-col md:flex-col md:gap-12 md:items-center justify-between md:pl-36 md:pr-36">
        <div >
          ...
          <div className=" flex flex-col gap-9">
            ...
            <div className="flex md:flex-row  flex-col md:m-0 ml-[21px] mr-[21px] gap-3">
              <input className=" drop-shadow-lg md:w-[300px] md:p-3" type="email" name="email" placeholder="Enter your email" />
