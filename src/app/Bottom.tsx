...
export default function Bottom() {
    return (
  <div>
       <div className="md:pt-32 mt-7 md:mt-o flex md:flex-row flex-col xl:justify-center justify-between md:pl-36 md:pr-36">
       <div >
        ...
        <div className="flex md:flex-row flex-col ml-[21px] md:m-0 md:mr-0  mr-[21px] gap-3">
